                                ...
                                <div class="row">
                                    <div class="col-3" @click="showImage(index)"
                                        ...
                                        <img :class="{ active: index === currentImage }" id="img-clickable"
                                            v-bind:src="product.images[index].get_image">
                                    </div>
                                    <!-- <div class="col" @click="showImage(2)">
                                            <img class="img-1t img-fluid" v-bind:src="product.get_image">
                                        </div>
                                        <div class="col" @click="showImage(3)">
                                            <img class="img-1t img-fluid" v-bind:src="product.get_image">
                                        </div>
                                        <div class="col" @click="showImage(4)">
                                            <img class="img-1t img-fluid" v-bind:src="product.get_image">
                                        </div> -->
                                </div>
                            </div>
                        ...
                        <div class="product-small-information col-5">
                            <div class="brand-productno row">
                                ...
                                <div class="productno col">
                                    <span class="product-article-label">Article no.: MF23.16694</span>
                                </div>
                            </div>
